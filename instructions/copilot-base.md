...
This file contains generic agent infrastructure policies that apply to any project using the code-intel toolchain. It is loaded automatically via workspace settings alongside the project-specific copilot instructions.
