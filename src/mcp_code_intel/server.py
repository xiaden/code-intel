...
def read_module_source(
    ...
    *,
    ...
    Accepts either:
      - qualified_name: dotted Python import path
      - file_path + symbol: filesystem path + dotted symbol name (e.g. from locate_module_symbol)

    Providing both or neither is a hard error.
